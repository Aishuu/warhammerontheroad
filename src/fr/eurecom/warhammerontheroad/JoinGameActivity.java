...
public class JoinGameActivity extends WotrActivity implements GameServiceListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.mService.addGameServiceListener(this);
	...
	protected void onDestroy() {
		this.mService.removeGameServiceListener(this);
		super.onDestroy();
	}
	...
	public void bind(View view) {
		...
		if(editName.getText().length() > 0 && editId.getText().length() > 0) {
			...
			this.mService.bind(Integer.parseInt(editId.getText().toString()));
		}
	}
	
	public void list(View view) {
		this.mService.listAvailableGames();
	}
